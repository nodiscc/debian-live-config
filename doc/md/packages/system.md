...
- ![](grey.png) _[apt-forktracer](https://packages.debian.org/trixie/apt-forktracer) `0.11` - utility for tracking non-official package versions_
- ![](grey.png) _[apt-listbugs](https://packages.debian.org/trixie/apt-listbugs) `0.1.47` - tool which lists critical bugs before each APT installation_
- ![](grey.png) _[aptitude-doc-fr](https://packages.debian.org/trixie/aptitude-doc-fr) `0.8.13-7` - French manual for aptitude, a terminal-based package manager_
...
- ![](green.png) [lm-sensors](https://packages.debian.org/trixie/lm-sensors) `1:3.6.2-2` - utilities to read temperature/voltage/fan sensors
- ![](green.png) [inxi](https://packages.debian.org/trixie/inxi) `3.3.38-1-1` - full featured system information script
- ![](green.png) [lsof](https://packages.debian.org/trixie/lsof) `4.99.4+dfsg-2` - utility to list open files
- ![](green.png) [strace](https://packages.debian.org/trixie/strace) `6.13+ds-1` - System call tracer
- ![](green.png) [memtest86+](https://packages.debian.org/trixie/memtest86+) `7.20-1` - stand-alone memory tester for x86 and x86-64
- ![](grey.png) _[gnome-system-monitor](https://packages.debian.org/trixie/gnome-system-monitor) `48.1-2` - Process viewer and system resource monitor for GNOME_
- ![](grey.png) _[screenfetch](https://packages.debian.org/trixie/screenfetch) `3.9.1+20210523-2` - Bash Screenshot Information Tool_
- ![](grey.png) _[hardinfo](https://packages.debian.org/trixie/hardinfo) `2.2.10-1` - transitional package_
- ![](grey.png) _[cputool](https://packages.debian.org/trixie/cputool) `0.0.8-2+b2` - Utility which manages CPU usage and system load_
- ![](grey.png) _[usbview](https://packages.debian.org/trixie/usbview) `3.1-2` - USB device viewer_
...
- ![](grey.png) _[stressapptest](https://packages.debian.org/trixie/stressapptest) `1.0.11-2+b1` - stress test application for simulating high load situations_
- ![](grey.png) _[lshw](https://packages.debian.org/trixie/lshw) `02.19.git.2021.06.19.996aaad9c7-2.1` - information about hardware configuration_
- ![](grey.png) _[lshw-gtk](https://packages.debian.org/trixie/lshw-gtk) `02.19.git.2021.06.19.996aaad9c7-2.1` - graphical information about hardware configuration_
- ![](grey.png) _[bonnie++](https://packages.debian.org/trixie/bonnie++) `2.00a+nmu3` - Hard drive benchmark suite_
...
- ![](grey.png) _[memtester](https://packages.debian.org/trixie/memtester) `4.7.1-1` - Utility for testing the memory subsystem_
- ![](grey.png) _[sysstat](https://packages.debian.org/trixie/sysstat) `12.7.5-2` - system performance tools for Linux_
- ![](grey.png) _[cacti](https://packages.debian.org/trixie/cacti) `1.2.30+ds1-1` - web interface for graphing of monitoring systems_
- ![](grey.png) _[hwloc](https://packages.debian.org/trixie/hwloc) `2.12.0-4` - Hierarchical view of the machine - utilities_
- ![](grey.png) _[memlockd](https://packages.debian.org/trixie/memlockd) `1.3.1-2` - daemon to lock files into RAM_
...
- ![](grey.png) _[cpu-x](https://packages.debian.org/trixie/cpu-x) `5.2.0-0.4` - Tool that gathers information on CPU, motherboard and more_
...
- ![](grey.png) _[duplicity](https://packages.debian.org/trixie/duplicity) `3.0.4-1+b1` - encrypted bandwidth-efficient backup_
- ![](grey.png) _[rdiff-backup](https://packages.debian.org/trixie/rdiff-backup) `2.2.6-3+b1` - remote incremental backup_
...
- ![](grey.png) _[duply](https://packages.debian.org/trixie/duply) `2.5.5-1` - easy to use frontend to the duplicity backup system_
...
- ![](green.png) [baobab](https://packages.debian.org/trixie/baobab) `48.0-2+b1` - GNOME disk usage analyzer
- ![](green.png) [ncdu](https://packages.debian.org/trixie/ncdu) `1.22-1` - ncurses disk usage viewer
- ![](green.png) [dfc](https://packages.debian.org/trixie/dfc) `3.1.1-2` - display file system usage using graph and colors
- ![](green.png) [smartmontools](https://packages.debian.org/trixie/smartmontools) `7.4-3` - control and monitor storage systems using S.M.A.R.T.
- ![](green.png) [mtools](https://packages.debian.org/trixie/mtools) `4.0.48-1` - Tools for manipulating MSDOS files
- ![](green.png) [gdisk](https://packages.debian.org/trixie/gdisk) `1.0.10-2` - GPT fdisk text-mode partitioning tool
- ![](green.png) [parted](https://packages.debian.org/trixie/parted) `3.6-5` - disk partition manipulator
- ![](green.png) [hdparm](https://packages.debian.org/trixie/hdparm) `9.65+ds-1.1` - tune hard disk parameters for high performance
...
- ![](grey.png) _[gsmartcontrol](https://packages.debian.org/trixie/gsmartcontrol) `2.0.2-1` - graphical user interface for smartctl_
- ![](grey.png) _[fsarchiver](https://packages.debian.org/trixie/fsarchiver) `0.8.8-1` - file system archiver_
- ![](grey.png) _[partclone](https://packages.debian.org/trixie/partclone) `0.3.36+repack-1` - Utility to clone and restore a partition_
- ![](grey.png) _[pmount](https://packages.debian.org/trixie/pmount) `0.9.23-9` - mount removable devices as normal user_
- ![](grey.png) _[bilibop-udev](https://packages.debian.org/trixie/bilibop-udev) `0.6.5` - minimal udev rule for Debian GNU/Linux running from external media_
- ![](grey.png) _[ecryptfs-utils](https://packages.debian.org/trixie/ecryptfs-utils) `111-8` - ecryptfs cryptographic filesystem (utilities)_
- ![](grey.png) _[partimage](https://packages.debian.org/trixie/partimage) `0.6.9-11+b1` - backup partitions into a compressed image file_
- ![](grey.png) _[steghide](https://packages.debian.org/trixie/steghide) `0.5.1-15` - steganography hiding tool_
- ![](grey.png) _[gdmap](https://packages.debian.org/trixie/gdmap) `1.3.1-1` - Tool to visualize diskspace_
- ![](grey.png) _[clonezilla](https://packages.debian.org/trixie/clonezilla) `5.9.9-1` - bare metal backup and recovery of disk drives_
- ![](grey.png) _[exfatprogs](https://packages.debian.org/trixie/exfatprogs) `1.2.9-1+deb13u1` - exFAT file system utilities_
...
- ![](grey.png) _[scalpel](https://packages.debian.org/trixie/scalpel) `1.60+git20240110.6960eb2-1` - fast filesystem-independent file recovery_
- ![](grey.png) _[gddrescue](https://packages.debian.org/trixie/gddrescue) `1.29-1` - GNU data recovery tool_
- ![](grey.png) _[ddrescueview](https://packages.debian.org/trixie/ddrescueview) `0.4.5-2` - graphical viewer for GNU ddrescue map files_
- ![](grey.png) _[extundelete](https://packages.debian.org/trixie/extundelete) `0.2.4-3+b2` - utility to recover deleted files from ext3/ext4 partition_
...
- ![](green.png) [colortail](https://packages.debian.org/trixie/colortail) `0.3.4+git20191125.ad3bc53-1` - log colorizer that makes log checking easier
- ![](grey.png) _[gnome-logs](https://packages.debian.org/trixie/gnome-logs) `45.0-1` - viewer for the systemd journal_
- ![](grey.png) _[glogg](https://packages.debian.org/trixie/glogg) `1.1.4-1.4` - Smart interactive log explorer using Qt_
...
- ![](green.png) [light-locker](https://packages.debian.org/trixie/light-locker) `1.8.0-3+b1` - simple screen locker for lightDM display manager
- ![](green.png) [accountsservice](https://packages.debian.org/trixie/accountsservice) `23.13.9-7` - query and manipulate user account information
- ![](grey.png) _[slim](https://packages.debian.org/trixie/slim) `1.4.1-2` - desktop-independent graphical login manager for X11_
- ![](grey.png) _[gdm3](https://packages.debian.org/trixie/gdm3) `48.0-2` - GNOME Display Manager_
- ![](grey.png) _[arctica-greeter](https://packages.debian.org/trixie/arctica-greeter) `0.99.9.4-1` - LightDM Arctica Greeter_
- ![](grey.png) _[xsecurelock](https://packages.debian.org/trixie/xsecurelock) `1.9.0-1` - X11 screen lock utility with the primary goal of security_
- ![](grey.png) _[xscreensaver](https://packages.debian.org/trixie/xscreensaver) `6.09+dfsg1-1` - Screensaver daemon and frontend for X11_
- ![](grey.png) _[xscreensaver-data-extra](https://packages.debian.org/trixie/xscreensaver-data-extra) `6.09+dfsg1-1` - Extra screen saver modules for screensaver frontends_
- ![](grey.png) _[xscreensaver-gl](https://packages.debian.org/trixie/xscreensaver-gl) `6.09+dfsg1-1` - GL(Mesa) screen saver modules for screensaver frontends_
- ![](grey.png) _[xscreensaver-gl-extra](https://packages.debian.org/trixie/xscreensaver-gl-extra) `6.09+dfsg1-1` - Extra GL(Mesa) screen saver modules for screensaver frontends_
#### Boot screen

- ![](green.png) [plymouth](https://packages.debian.org/trixie/plymouth) `24.004.60-5` - boot animation, logger and I/O multiplexer
- ![](green.png) [plymouth-themes](https://packages.debian.org/trixie/plymouth-themes) `24.004.60-5` - boot animation, logger and I/O multiplexer - themes
#### Scheduling
...
- ![](grey.png) _[preload](https://packages.debian.org/trixie/preload) `0.6.4-5+b2` - adaptive readahead daemon_
#### Security & sandboxing

- ![](green.png) [apparmor](https://packages.debian.org/trixie/apparmor) `4.1.0-1` - user-space parser utility for AppArmor
...
- ![](green.png) [xinit](https://packages.debian.org/trixie/xinit) `1.4.2-1` - X server initialisation tool
...
- ![](green.png) [xfonts-75dpi](https://packages.debian.org/trixie/xfonts-75dpi) `1:1.0.5` - 75 dpi fonts for X
- ![](green.png) [xfonts-100dpi](https://packages.debian.org/trixie/xfonts-100dpi) `1:1.0.5` - 100 dpi fonts for X
- ![](green.png) [xserver-xorg](https://packages.debian.org/trixie/xserver-xorg) `1:7.7+24+deb13u1` - X.Org X server
- ![](green.png) [xserver-xorg-input-all](https://packages.debian.org/trixie/xserver-xorg-input-all) `1:7.7+24+deb13u1` - X.Org X server -- input driver metapackage
- ![](green.png) [xserver-xorg-input-wacom](https://packages.debian.org/trixie/xserver-xorg-input-wacom) `1.2.3-1` - X.Org X server -- Wacom input driver
- ![](green.png) [xserver-xorg-input-joystick](https://packages.debian.org/trixie/xserver-xorg-input-joystick) `1:1.6.4-1` - X.Org X server -- joystick input driver
...
- ![](green.png) [xserver-xorg-input-multitouch](https://packages.debian.org/trixie/xserver-xorg-input-multitouch) `1.0~rc3-2.1` - Multitouch X input driver
- ![](green.png) [xserver-xorg-input-synaptics](https://packages.debian.org/trixie/xserver-xorg-input-synaptics) `1.9.2-1+b2` - Synaptics TouchPad driver for X.Org server
- ![](green.png) [xserver-xorg-video-all](https://packages.debian.org/trixie/xserver-xorg-video-all) `1:7.7+24+deb13u1` - X.Org X server -- output driver metapackage
...
- ![](green.png) [xfonts-base](https://packages.debian.org/trixie/xfonts-base) `1:1.0.5+nmu1` - standard fonts for X
- ![](green.png) [hwdata](https://packages.debian.org/trixie/hwdata) `0.394-1` - hardware identification / configuration data
- ![](grey.png) _[nvidia-driver](https://packages.debian.org/trixie/nvidia-driver) `550.163.01-2` - NVIDIA metapackage_
- ![](grey.png) _[nvidia-vaapi-driver](https://packages.debian.org/trixie/nvidia-vaapi-driver) `0.0.13-1` - VA-API implementation that uses NVDEC as a backend_
- ![](grey.png) _[xserver-xorg-input-aiptek](https://packages.debian.org/trixie/xserver-xorg-input-aiptek) `1:1.4.1-5` - X.Org X server -- Aiptek input driver_
...
- ![](green.png) [live-config](https://packages.debian.org/trixie/live-config) `11.0.5` - Live System Configuration Components
