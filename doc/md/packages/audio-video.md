...
<img align="right" src="https://screenshots.debian.net/thumbnail-with-version/vlc/3.0.18-2">
...
- ![](green.png) [vlc](https://packages.debian.org/bookworm/vlc) `3.0.18-2` - multimedia player and streamer
- ![](green.png) [vlc-plugin-notify](https://packages.debian.org/bookworm/vlc-plugin-notify) `3.0.18-2` - LibNotify plugin for VLC
- ![](green.png) [vlc-plugin-jack](https://packages.debian.org/bookworm/vlc-plugin-jack) `3.0.18-2` - JACK audio plugins for VLC
- ![](green.png) [vlc-plugin-samba](https://packages.debian.org/bookworm/vlc-plugin-samba) `3.0.18-2` - Samba plugin for VLC
- ![](green.png) [vlc-plugin-skins2](https://packages.debian.org/bookworm/vlc-plugin-skins2) `3.0.18-2` - multimedia player and streamer (Skins2 plugin)
- ![](green.png) [vlc-plugin-video-splitter](https://packages.debian.org/bookworm/vlc-plugin-video-splitter) `3.0.18-2` - multimedia player and streamer (video splitter plugins)
- ![](green.png) [vlc-plugin-visualization](https://packages.debian.org/bookworm/vlc-plugin-visualization) `3.0.18-2` - multimedia player and streamer (visualization plugins)
- ![](green.png) [vlc-plugin-video-output](https://packages.debian.org/bookworm/vlc-plugin-video-output) `3.0.18-2` - multimedia player and streamer (video output plugins)
- ![](green.png) [vlc-plugin-base](https://packages.debian.org/bookworm/vlc-plugin-base) `3.0.18-2` - multimedia player and streamer (base plugins)
- ![](green.png) [vlc-plugin-qt](https://packages.debian.org/bookworm/vlc-plugin-qt) `3.0.18-2` - multimedia player and streamer (Qt plugin)
...
- ![](grey.png) _[vlc-plugin-svg](https://packages.debian.org/bookworm/vlc-plugin-svg) `3.0.18-2` - SVG plugin for VLC_
...
- ![](green.png) [ffmpeg](https://packages.debian.org/bookworm/ffmpeg) `7:5.1.3-1` - Tools for transcoding, streaming and playing of multimedia files
...
- ![](green.png) [gstreamer1.0-plugins-bad](https://packages.debian.org/bookworm/gstreamer1.0-plugins-bad) `1.22.0-4+deb12u1` - GStreamer plugins from the "bad" set
...
- ![](green.png) [gstreamer1.0-plugins-ugly](https://packages.debian.org/bookworm/gstreamer1.0-plugins-ugly) `1.22.0-2` - GStreamer plugins from the "ugly" set
...
- ![](green.png) [media-player-info](https://packages.debian.org/bookworm/media-player-info) `24-2` - Media player identification files
...
- ![](grey.png) _[subliminal](https://packages.debian.org/bookworm/subliminal) `2.1.0-3` - Command-line tool to search and download subtitles_
...
- ![](grey.png) _[pulseaudio-equalizer](https://packages.debian.org/bookworm/pulseaudio-equalizer) `16.1+dfsg1-2+b1` - Equalizer sink module for PulseAudio sound server_
